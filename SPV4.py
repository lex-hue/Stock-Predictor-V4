...
def install_dependencies():
    print("Installing all dependencies for SPV4...")
    import os
    import subprocess
    import time
    ...
    if __name__ == "__main__":
        print("Cancel the script if you didn't set up the virtual environment yet (Optional)")
        time.sleep(2)
        os.system("clear")
        print("If you did or don't want a virtual environment setup, wait 3 seconds")
        time.sleep(3)

        # Download TA-Lib
        ta_lib_url = "https://deac-fra.dl.sourceforge.net/project/ta-lib/ta-lib/0.4.0/ta-lib-0.4.0-src.tar.gz"
        ta_lib_filename = "ta-lib-0.4.0-src.tar.gz"
        download_file(ta_lib_url, ta_lib_filename)

        # Extract TA-Lib
        extract_tar_gz(ta_lib_filename)
